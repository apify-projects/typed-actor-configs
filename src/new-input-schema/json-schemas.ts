...
// anyProperty deleted
// array of arrays deleted

type Minimal<T extends { title: string; description: string }> = Omit<
    T,
    'title' | 'description' | 'sectionCaption' | 'sectionDescription' | 'prefill' | 'example'
>;
...
} as const satisfies JSONSchema; // falta
