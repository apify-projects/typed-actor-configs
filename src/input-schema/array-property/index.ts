...
const baseArrayPropertySchema = minimalArraySchema.and(
    z.object({
        title: z.string(),
...
export type ArrayPropertyType<Input extends z.infer<typeof arrayTypesSchema>> = Input extends z.infer<
    typeof minimalStringArraySchema
>
    ? string[]
    : never;
