...
declare const inputSchema: z.ZodObject<{
    ...
    required: z.ZodDefault<z.ZodOptional<z.ZodArray<z.ZodString>>>;
}, z.z.core.$strip>;
...
export declare function defineMinimalInputConfiguration<Properties extends string, Requireds extends Properties, Schema extends MinimalInputSchema>(path: `${string}/input_schema.json` | `${string}/INPUT_SCHEMA.json`, input: Schema & {
    properties: {
