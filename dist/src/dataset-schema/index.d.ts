...
export declare function validateDatasetFieldsWithSchema<PassthroughType extends Dataset['fields'], Fields extends JSONSchema, Properties extends string | never, Requireds extends Properties>(config: {
    fields: object;
